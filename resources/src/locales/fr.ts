export default {
  common: {
    ...
    selectText: 'Sélectionner une option',
    ...
    ok: 'OK',
    cancel: 'Annuler',
    reload: 'Recharger onglet courant',
    closeTab: 'Fermer onglet courant',
    closeTheLeftTab: 'Fermer onglet gauche',
    closeTheRightTab: 'Fermer onglet droit',
  ...
  import: {
    ...
    message: 'Imorter le fichier Excel des données'
  },
  formDemo: {
    input: 'Input',
